...
// in prestashop_api/test/product/product_data_source_test.dart.
...
import 'package:prestashop_api/src/base_config.dart' as _i10;
import 'package:prestashop_api/src/common/uri_builder.dart' as _i12;
...
/// A class which mocks [BaseConfig].
///
/// See the documentation for Mockito's code generation for more information.
class MockBaseConfig extends _i1.Mock implements _i10.BaseConfig {
  @override
  String get baseUrl =>
      (super.noSuchMethod(
  ...
  @override
  _i12.Protocol get protocol =>
      (super.noSuchMethod(
            Invocation.getter(#protocol),
            returnValue: _i12.Protocol.http,
            returnValueForMissingStub: _i12.Protocol.http,
          )
          as _i12.Protocol);
}
