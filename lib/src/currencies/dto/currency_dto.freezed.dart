...
@override
String toString() {
  return 'CurrencyDTO(id: $id, names: $names, name: $name, symbol: $symbol, isoCode: $isoCode, numericIsoCode: $numericIsoCode, precision: $precision, conversionRate: $conversionRate, deleted: $deleted, active: $active, unofficial: $unofficial, modified: $modified, pattern: $pattern)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: stringFromDynamicJson)  String? names,  String? name, @JsonKey(fromJson: stringFromDynamicJson)  String? symbol, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'numeric_iso_code')  String? numericIsoCode, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? precision, @JsonKey(name: 'conversion_rate', fromJson: parseIsFloat, toJson: isFloatToJson)  double? conversionRate, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? unofficial, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? modified, @JsonKey(fromJson: stringFromDynamicJson)  String? pattern)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CurrencyDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: stringFromDynamicJson)  String? names,  String? name, @JsonKey(fromJson: stringFromDynamicJson)  String? symbol, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'numeric_iso_code')  String? numericIsoCode, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? precision, @JsonKey(name: 'conversion_rate', fromJson: parseIsFloat, toJson: isFloatToJson)  double? conversionRate, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? unofficial, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? modified, @JsonKey(fromJson: stringFromDynamicJson)  String? pattern)  $default,) {final _that = this;
switch (_that) {
case _CurrencyDTO():
return $default(_that.id,_that.names,_that.name,_that.symbol,_that.isoCode,_that.numericIsoCode,_that.precision,_that.conversionRate,_that.deleted,_that.active,_that.unofficial,_that.modified,_that.pattern);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(fromJson: stringFromDynamicJson)  String? names,  String? name, @JsonKey(fromJson: stringFromDynamicJson)  String? symbol, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'numeric_iso_code')  String? numericIsoCode, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? precision, @JsonKey(name: 'conversion_rate', fromJson: parseIsFloat, toJson: isFloatToJson)  double? conversionRate, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? unofficial, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? modified, @JsonKey(fromJson: stringFromDynamicJson)  String? pattern)?  $default,) {final _that = this;
switch (_that) {
case _CurrencyDTO() when $default != null:
return $default(_that.id,_that.names,_that.name,_that.symbol,_that.isoCode,_that.numericIsoCode,_that.precision,_that.conversionRate,_that.deleted,_that.active,_that.unofficial,_that.modified,_that.pattern);case _:
  return null;
...
class _CurrencyDTO extends CurrencyDTO {
  const _CurrencyDTO({this.id, @JsonKey(fromJson: stringFromDynamicJson) this.names, this.name, @JsonKey(fromJson: stringFromDynamicJson) this.symbol, @JsonKey(name: 'iso_code') this.isoCode, @JsonKey(name: 'numeric_iso_code') this.numericIsoCode, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson) this.precision, @JsonKey(name: 'conversion_rate', fromJson: parseIsFloat, toJson: isFloatToJson) this.conversionRate, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.deleted, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.active, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.unofficial, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.modified, @JsonKey(fromJson: stringFromDynamicJson) this.pattern}): super._();
  factory _CurrencyDTO.fromJson(Map<String, dynamic> json) => _$CurrencyDTOFromJson(json);

@override final  int? id;
@override@JsonKey(fromJson: stringFromDynamicJson) final  String? names;
@override final  String? name;
@override@JsonKey(fromJson: stringFromDynamicJson) final  String? symbol;
...
@override@JsonKey(fromJson: stringFromDynamicJson) final  String? pattern;
