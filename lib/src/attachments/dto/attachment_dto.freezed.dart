...
mixin _$AttachmentDTO {
 ...
 int? get id; String? get file;@JsonKey(name: 'file_name') String? get fileName;@JsonKey(name: 'file_size', fromJson: intFromJson) int? get fileSize; String? get mime; String? get name; String? get description;@JsonKey(fromJson: _associationsFromJson) AttachmentAssociationsDTO? get associations;
...
@useResult
$Res call({
 int? id, String? file,@JsonKey(name: 'file_name') String? fileName,@JsonKey(name: 'file_size', fromJson: intFromJson) int? fileSize, String? mime, String? name, String? description,@JsonKey(fromJson: _associationsFromJson) AttachmentAssociationsDTO? associations
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? file, @JsonKey(name: 'file_name')  String? fileName, @JsonKey(name: 'file_size', fromJson: intFromJson)  int? fileSize,  String? mime,  String? name,  String? description, @JsonKey(fromJson: _associationsFromJson)  AttachmentAssociationsDTO? associations)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttachmentDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? file, @JsonKey(name: 'file_name')  String? fileName, @JsonKey(name: 'file_size', fromJson: intFromJson)  int? fileSize,  String? mime,  String? name,  String? description, @JsonKey(fromJson: _associationsFromJson)  AttachmentAssociationsDTO? associations)  $default,) {final _that = this;
switch (_that) {
case _AttachmentDTO():
return $default(_that.id,_that.file,_that.fileName,_that.fileSize,_that.mime,_that.name,_that.description,_that.associations);case _:
  throw StateError('Unexpected subclass');
...
class _AttachmentDTO extends AttachmentDTO {
  const _AttachmentDTO({this.id, this.file, @JsonKey(name: 'file_name') this.fileName, @JsonKey(name: 'file_size', fromJson: intFromJson) this.fileSize, this.mime, this.name, this.description, @JsonKey(fromJson: _associationsFromJson) this.associations}): super._();
  factory _AttachmentDTO.fromJson(Map<String, dynamic> json) => _$AttachmentDTOFromJson(json);

@override final  int? id;
@override final  String? file;
@override@JsonKey(name: 'file_name') final  String? fileName;
@override@JsonKey(name: 'file_size', fromJson: intFromJson) final  int? fileSize;
