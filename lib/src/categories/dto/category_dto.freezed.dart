...
mixin _$CategoryDTO {
 ...
 int? get id;@JsonKey(name: 'id_parent', fromJson: stringFromJson) String? get idParent;@JsonKey(name: 'level_depth', fromJson: stringFromJson) String? get levelDepth;@JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson) String? get nbProductsRecursive;@JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson) bool? get active;@JsonKey(name: 'id_shop_default', fromJson: stringFromJson) String? get idShopDefault;@JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson) bool? get isRootCategory;@JsonKey(fromJson: stringFromJson) String? get position;@JsonKey(name: 'date_add', fromJson: dateTimeFromJson) DateTime? get dateAdd;@JsonKey(name: 'date_upd', fromJson: dateTimeFromJson) DateTime? get dateUpd; String? get name;@JsonKey(name: 'link_rewrite') String? get linkRewrite; String? get description;@JsonKey(name: 'meta_title') String? get metaTitle;@JsonKey(name: 'meta_description') String? get metaDescription;@JsonKey(name: 'meta_keywords') String? get metaKeywords;@JsonKey(fromJson: _associationsFromJson) CategoryAssociationsDTO? get associations;
...
@useResult
$Res call({
 int? id,@JsonKey(name: 'id_parent', fromJson: stringFromJson) String? idParent,@JsonKey(name: 'level_depth', fromJson: stringFromJson) String? levelDepth,@JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson) String? nbProductsRecursive,@JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson) bool? active,@JsonKey(name: 'id_shop_default', fromJson: stringFromJson) String? idShopDefault,@JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson) bool? isRootCategory,@JsonKey(fromJson: stringFromJson) String? position,@JsonKey(name: 'date_add', fromJson: dateTimeFromJson) DateTime? dateAdd,@JsonKey(name: 'date_upd', fromJson: dateTimeFromJson) DateTime? dateUpd, String? name,@JsonKey(name: 'link_rewrite') String? linkRewrite, String? description,@JsonKey(name: 'meta_title') String? metaTitle,@JsonKey(name: 'meta_description') String? metaDescription,@JsonKey(name: 'meta_keywords') String? metaKeywords,@JsonKey(fromJson: _associationsFromJson) CategoryAssociationsDTO? associations
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_parent', fromJson: stringFromJson)  String? idParent, @JsonKey(name: 'level_depth', fromJson: stringFromJson)  String? levelDepth, @JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson)  String? nbProductsRecursive, @JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson)  bool? active, @JsonKey(name: 'id_shop_default', fromJson: stringFromJson)  String? idShopDefault, @JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson)  bool? isRootCategory, @JsonKey(fromJson: stringFromJson)  String? position, @JsonKey(name: 'date_add', fromJson: dateTimeFromJson)  DateTime? dateAdd, @JsonKey(name: 'date_upd', fromJson: dateTimeFromJson)  DateTime? dateUpd,  String? name, @JsonKey(name: 'link_rewrite')  String? linkRewrite,  String? description, @JsonKey(name: 'meta_title')  String? metaTitle, @JsonKey(name: 'meta_description')  String? metaDescription, @JsonKey(name: 'meta_keywords')  String? metaKeywords, @JsonKey(fromJson: _associationsFromJson)  CategoryAssociationsDTO? associations)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_parent', fromJson: stringFromJson)  String? idParent, @JsonKey(name: 'level_depth', fromJson: stringFromJson)  String? levelDepth, @JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson)  String? nbProductsRecursive, @JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson)  bool? active, @JsonKey(name: 'id_shop_default', fromJson: stringFromJson)  String? idShopDefault, @JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson)  bool? isRootCategory, @JsonKey(fromJson: stringFromJson)  String? position, @JsonKey(name: 'date_add', fromJson: dateTimeFromJson)  DateTime? dateAdd, @JsonKey(name: 'date_upd', fromJson: dateTimeFromJson)  DateTime? dateUpd,  String? name, @JsonKey(name: 'link_rewrite')  String? linkRewrite,  String? description, @JsonKey(name: 'meta_title')  String? metaTitle, @JsonKey(name: 'meta_description')  String? metaDescription, @JsonKey(name: 'meta_keywords')  String? metaKeywords, @JsonKey(fromJson: _associationsFromJson)  CategoryAssociationsDTO? associations)  $default,) {final _that = this;
switch (_that) {
case _CategoryDTO():
return $default(_that.id,_that.idParent,_that.levelDepth,_that.nbProductsRecursive,_that.active,_that.idShopDefault,_that.isRootCategory,_that.position,_that.dateAdd,_that.dateUpd,_that.name,_that.linkRewrite,_that.description,_that.metaTitle,_that.metaDescription,_that.metaKeywords,_that.associations);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(name: 'id_parent', fromJson: stringFromJson)  String? idParent, @JsonKey(name: 'level_depth', fromJson: stringFromJson)  String? levelDepth, @JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson)  String? nbProductsRecursive, @JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson)  bool? active, @JsonKey(name: 'id_shop_default', fromJson: stringFromJson)  String? idShopDefault, @JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson)  bool? isRootCategory, @JsonKey(fromJson: stringFromJson)  String? position, @JsonKey(name: 'date_add', fromJson: dateTimeFromJson)  DateTime? dateAdd, @JsonKey(name: 'date_upd', fromJson: dateTimeFromJson)  DateTime? dateUpd,  String? name, @JsonKey(name: 'link_rewrite')  String? linkRewrite,  String? description, @JsonKey(name: 'meta_title')  String? metaTitle, @JsonKey(name: 'meta_description')  String? metaDescription, @JsonKey(name: 'meta_keywords')  String? metaKeywords, @JsonKey(fromJson: _associationsFromJson)  CategoryAssociationsDTO? associations)?  $default,) {final _that = this;
switch (_that) {
case _CategoryDTO() when $default != null:
return $default(_that.id,_that.idParent,_that.levelDepth,_that.nbProductsRecursive,_that.active,_that.idShopDefault,_that.isRootCategory,_that.position,_that.dateAdd,_that.dateUpd,_that.name,_that.linkRewrite,_that.description,_that.metaTitle,_that.metaDescription,_that.metaKeywords,_that.associations);case _:
  return null;
...
class _CategoryDTO extends CategoryDTO {
  const _CategoryDTO({this.id, @JsonKey(name: 'id_parent', fromJson: stringFromJson) this.idParent, @JsonKey(name: 'level_depth', fromJson: stringFromJson) this.levelDepth, @JsonKey(name: 'nb_products_recursive', fromJson: stringFromDynamicJson) this.nbProductsRecursive, @JsonKey(name: 'active', fromJson: boolFromJson, toJson: boolToJson) this.active, @JsonKey(name: 'id_shop_default', fromJson: stringFromJson) this.idShopDefault, @JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson) this.isRootCategory, @JsonKey(fromJson: stringFromJson) this.position, @JsonKey(name: 'date_add', fromJson: dateTimeFromJson) this.dateAdd, @JsonKey(name: 'date_upd', fromJson: dateTimeFromJson) this.dateUpd, this.name, @JsonKey(name: 'link_rewrite') this.linkRewrite, this.description, @JsonKey(name: 'meta_title') this.metaTitle, @JsonKey(name: 'meta_description') this.metaDescription, @JsonKey(name: 'meta_keywords') this.metaKeywords, @JsonKey(fromJson: _associationsFromJson) this.associations}): super._();
  factory _CategoryDTO.fromJson(Map<String, dynamic> json) => _$CategoryDTOFromJson(json);

@override final  int? id;
@override@JsonKey(name: 'id_parent', fromJson: stringFromJson) final  String? idParent;
@override@JsonKey(name: 'level_depth', fromJson: stringFromJson) final  String? levelDepth;
...
@override@JsonKey(name: 'is_root_category', fromJson: boolFromJson, toJson: boolToJson) final  bool? isRootCategory;
@override@JsonKey(fromJson: stringFromJson) final  String? position;
