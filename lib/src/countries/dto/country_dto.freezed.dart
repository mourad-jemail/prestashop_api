...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_zone', fromJson: parseNullOrUnsignedId)  int? idZone, @JsonKey(name: 'id_currency', fromJson: parseNullOrUnsignedId)  int? idCurrency, @JsonKey(name: 'call_prefix', fromJson: parseIsInt, toJson: isIntToJson)  int? callPrefix, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'contains_states', fromJson: parseIsBool, toJson: isBoolToJson)  bool? containsStates, @JsonKey(name: 'need_identification_number', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needIdentificationNumber, @JsonKey(name: 'need_zip_code', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needZipCode, @JsonKey(name: 'zip_code_format')  String? zipCodeFormat, @JsonKey(name: 'display_tax_label', fromJson: parseIsBool, toJson: isBoolToJson)  bool? displayTaxLabel,  String? name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CountryDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_zone', fromJson: parseNullOrUnsignedId)  int? idZone, @JsonKey(name: 'id_currency', fromJson: parseNullOrUnsignedId)  int? idCurrency, @JsonKey(name: 'call_prefix', fromJson: parseIsInt, toJson: isIntToJson)  int? callPrefix, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'contains_states', fromJson: parseIsBool, toJson: isBoolToJson)  bool? containsStates, @JsonKey(name: 'need_identification_number', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needIdentificationNumber, @JsonKey(name: 'need_zip_code', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needZipCode, @JsonKey(name: 'zip_code_format')  String? zipCodeFormat, @JsonKey(name: 'display_tax_label', fromJson: parseIsBool, toJson: isBoolToJson)  bool? displayTaxLabel,  String? name)  $default,) {final _that = this;
switch (_that) {
case _CountryDTO():
return $default(_that.id,_that.idZone,_that.idCurrency,_that.callPrefix,_that.isoCode,_that.active,_that.containsStates,_that.needIdentificationNumber,_that.needZipCode,_that.zipCodeFormat,_that.displayTaxLabel,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(name: 'id_zone', fromJson: parseNullOrUnsignedId)  int? idZone, @JsonKey(name: 'id_currency', fromJson: parseNullOrUnsignedId)  int? idCurrency, @JsonKey(name: 'call_prefix', fromJson: parseIsInt, toJson: isIntToJson)  int? callPrefix, @JsonKey(name: 'iso_code')  String? isoCode, @JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'contains_states', fromJson: parseIsBool, toJson: isBoolToJson)  bool? containsStates, @JsonKey(name: 'need_identification_number', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needIdentificationNumber, @JsonKey(name: 'need_zip_code', fromJson: parseIsBool, toJson: isBoolToJson)  bool? needZipCode, @JsonKey(name: 'zip_code_format')  String? zipCodeFormat, @JsonKey(name: 'display_tax_label', fromJson: parseIsBool, toJson: isBoolToJson)  bool? displayTaxLabel,  String? name)?  $default,) {final _that = this;
switch (_that) {
case _CountryDTO() when $default != null:
return $default(_that.id,_that.idZone,_that.idCurrency,_that.callPrefix,_that.isoCode,_that.active,_that.containsStates,_that.needIdentificationNumber,_that.needZipCode,_that.zipCodeFormat,_that.displayTaxLabel,_that.name);case _:
  return null;
...
@override@JsonKey(name: 'call_prefix', fromJson: parseIsInt, toJson: isIntToJson) final  int? callPrefix;
