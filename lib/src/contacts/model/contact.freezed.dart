...
mixin _$Contact {
 ...
 int? get id; String? get name; bool? get customerService; String? get email; String? get description;
...
@override
String toString() {
  return 'Contact(id: $id, name: $name, customerService: $customerService, email: $email, description: $description)';
}
...
@useResult
$Res call({
 int? id, String? name, bool? customerService, String? email, String? description
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? name,  bool? customerService,  String? email,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Contact() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? name,  bool? customerService,  String? email,  String? description)  $default,) {final _that = this;
switch (_that) {
case _Contact():
return $default(_that.id,_that.name,_that.customerService,_that.email,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? name,  bool? customerService,  String? email,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _Contact() when $default != null:
return $default(_that.id,_that.name,_that.customerService,_that.email,_that.description);case _:
  return null;
...
class _Contact extends Contact {
  const _Contact({this.id, this.name, this.customerService, this.email, this.description}): super._();
  factory _Contact.fromJson(Map<String, dynamic> json) => _$ContactFromJson(json);

@override final  int? id;
@override final  String? name;
@override final  bool? customerService;
