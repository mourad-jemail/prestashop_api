...
$CountryOutputDTOCopyWith<CountryOutputDTO> get copyWith => _$CountryOutputDTOCopyWithImpl<CountryOutputDTO>(this as CountryOutputDTO, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CountryOutputDTO&&const DeepCollectionEquality().equals(other.countryDTOList, countryDTOList));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(countryDTOList));
...
abstract mixin class $CountryOutputDTOCopyWith<$Res>  {
  factory $CountryOutputDTOCopyWith(CountryOutputDTO value, $Res Function(CountryOutputDTO) _then) = _$CountryOutputDTOCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of CountryOutputDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? countryDTOList = null,}) {
  return _then(_self.copyWith(
countryDTOList: null == countryDTOList ? _self.countryDTOList : countryDTOList // ignore: cast_nullable_to_non_nullable
as List<CountryDTO>,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CountryOutputDTO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _CountryOutputDTO extends CountryOutputDTO {
  const _CountryOutputDTO({@JsonKey(name: 'countries') required final  List<CountryDTO> countryDTOList}): _countryDTOList = countryDTOList,super._();
  factory _CountryOutputDTO.fromJson(Map<String, dynamic> json) => _$CountryOutputDTOFromJson(json);

 final  List<CountryDTO> _countryDTOList;
@override@JsonKey(name: 'countries') List<CountryDTO> get countryDTOList {
...
@pragma('vm:prefer-inline')
_$CountryOutputDTOCopyWith<_CountryOutputDTO> get copyWith => __$CountryOutputDTOCopyWithImpl<_CountryOutputDTO>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CountryOutputDTO&&const DeepCollectionEquality().equals(other._countryDTOList, _countryDTOList));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_countryDTOList));
...
/// @nodoc
abstract mixin class _$CountryOutputDTOCopyWith<$Res> implements $CountryOutputDTOCopyWith<$Res> {
  factory _$CountryOutputDTOCopyWith(_CountryOutputDTO value, $Res Function(_CountryOutputDTO) _then) = __$CountryOutputDTOCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'countries') List<CountryDTO> countryDTOList
});
...
/// Create a copy of CountryOutputDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? countryDTOList = null,}) {
  return _then(_CountryOutputDTO(
countryDTOList: null == countryDTOList ? _self._countryDTOList : countryDTOList // ignore: cast_nullable_to_non_nullable
as List<CountryDTO>,
  ));
}
