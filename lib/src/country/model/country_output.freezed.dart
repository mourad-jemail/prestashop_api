...
mixin _$CountryOutput {
  ...
  $CountryOutputCopyWith<CountryOutput> get copyWith =>
      _$CountryOutputCopyWithImpl<CountryOutput>(
          this as CountryOutput, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is CountryOutput &&
...
abstract mixin class $CountryOutputCopyWith<$Res> {
  factory $CountryOutputCopyWith(CountryOutput value,
      $Res Function(CountryOutput) _then) = _$CountryOutputCopyWithImpl;
...
extension CountryOutputPatterns on CountryOutput {
  ...
  TResult Function( _CountryOutput value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _CountryOutput extends CountryOutput {
  const _CountryOutput({required final List<Country> countryList})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CountryOutputCopyWith<_CountryOutput> get copyWith =>
      __$CountryOutputCopyWithImpl<_CountryOutput>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _CountryOutput &&
            const DeepCollectionEquality().equals(
                other._countryList, _countryList));
  }
...
/// @nodoc
abstract mixin class _$CountryOutputCopyWith<$Res>
    implements $CountryOutputCopyWith<$Res> {
  factory _$CountryOutputCopyWith(_CountryOutput value,
      $Res Function(_CountryOutput) _then) = __$CountryOutputCopyWithImpl;
