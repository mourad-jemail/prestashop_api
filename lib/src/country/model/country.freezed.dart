...
mixin _$Country {
 ...
 int? get id; String? get idZone; String? get idCurrency; String? get callPrefix; String? get isoCode; bool? get active; bool? get containsStates; bool? get needIdentificationNumber; bool? get needZipCode; String? get zipCodeFormat; bool? get displayTaxLabel; String? get name;
...
class _Country extends Country {
  const _Country({this.id, this.idZone, this.idCurrency, this.callPrefix, this.isoCode, this.active, this.containsStates, this.needIdentificationNumber, this.needZipCode, this.zipCodeFormat, this.displayTaxLabel, this.name}): super._();
