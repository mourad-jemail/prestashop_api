...
mixin _$ProductFeatureDTO {
 ...
 int? get id;@JsonKey(name: 'id_feature_value') String? get idFeatureValue;@JsonKey(fromJson: parseIsInt, toJson: isIntToJson) int? get position; String? get name;
...
@useResult
$Res call({
 int? id,@JsonKey(name: 'id_feature_value') String? idFeatureValue,@JsonKey(fromJson: parseIsInt, toJson: isIntToJson) int? position, String? name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_feature_value')  String? idFeatureValue, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? position,  String? name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductFeatureDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(name: 'id_feature_value')  String? idFeatureValue, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? position,  String? name)  $default,) {final _that = this;
switch (_that) {
case _ProductFeatureDTO():
return $default(_that.id,_that.idFeatureValue,_that.position,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(name: 'id_feature_value')  String? idFeatureValue, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson)  int? position,  String? name)?  $default,) {final _that = this;
switch (_that) {
case _ProductFeatureDTO() when $default != null:
return $default(_that.id,_that.idFeatureValue,_that.position,_that.name);case _:
  return null;
...
class _ProductFeatureDTO extends ProductFeatureDTO {
  const _ProductFeatureDTO({this.id, @JsonKey(name: 'id_feature_value') this.idFeatureValue, @JsonKey(fromJson: parseIsInt, toJson: isIntToJson) this.position, this.name}): super._();
