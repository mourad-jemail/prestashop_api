...
/// @nodoc
mixin _$Filter<T extends FieldEnumValue> {
...
/// @nodoc
abstract class $FilterCopyWith<T extends FieldEnumValue, $Res> {
...
/// @nodoc
class _$FilterCopyWithImpl<T extends FieldEnumValue, $Res,
...
/// @nodoc
abstract class _$$FilterImplCopyWith<T extends FieldEnumValue, $Res>
...
/// @nodoc
class __$$FilterImplCopyWithImpl<T extends FieldEnumValue, $Res>
...
class _$FilterImpl<T extends FieldEnumValue> extends _Filter<T> {
  const _$FilterImpl(
      {required this.field,
  ...
  @override
  String toString() {
    return 'Filter<$T>(field: $field, condition: $condition, values: $values, start: $start, end: $end, value: $value)';
  }
...
abstract class _Filter<T extends FieldEnumValue> extends Filter<T> {
