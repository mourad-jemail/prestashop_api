...
abstract class SupplierDTO with _$SupplierDTO {
  ...
  const factory SupplierDTO({
    ...
    DateTime? dateUpd,
    @JsonKey(fromJson: stringFromDynamicJson) String? description,
    @JsonKey(name: 'meta_title', fromJson: stringFromDynamicJson)
    String? metaTitle,
    @JsonKey(name: 'meta_description', fromJson: stringFromDynamicJson)
    String? metaDescription,
    @JsonKey(name: 'meta_keywords', fromJson: stringFromDynamicJson)
    String? metaKeywords,
  }) = _SupplierDTO;
