...
_CarrierDTO _$CarrierDTOFromJson(Map<String, dynamic> json) => _CarrierDTO(
  ...
  idTaxRulesGroup: stringFromDynamicJson(json['id_tax_rules_group']),
  idReference: stringFromDynamicJson(json['id_reference']),
  name: json['name'] as String?,
  active: parseIsBool(json['active']),
  isFree: parseIsBool(json['is_free']),
  url: json['url'] as String?,
  shippingHandling: parseIsBool(json['shipping_handling']),
  shippingExternal: stringFromDynamicJson(json['shipping_external']),
  rangeBehavior: parseIsBool(json['range_behavior']),
  shippingMethod: parseNullOrUnsignedId(json['shipping_method']),
  maxWidth: parseNullOrUnsignedId(json['max_width']),
  maxHeight: parseNullOrUnsignedId(json['max_height']),
  maxDepth: parseNullOrUnsignedId(json['max_depth']),
  maxWeight: parseIsFloat(json['max_weight']),
  grade: parseNullOrUnsignedId(json['grade']),
  externalModuleName: stringFromDynamicJson(json['external_module_name']),
  needRange: stringFromDynamicJson(json['need_range']),
