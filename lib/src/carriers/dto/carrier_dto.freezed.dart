...
mixin _$CarrierDTO {
 ...
 int? get id;@JsonKey(fromJson: boolFromJson, toJson: boolToJson) bool? get deleted;@JsonKey(name: 'is_module', fromJson: boolFromJson, toJson: boolToJson) bool? get isModule;@JsonKey(name: 'id_tax_rules_group') String? get idTaxRulesGroup;@JsonKey(name: 'id_reference') String? get idReference; String? get name;@JsonKey(fromJson: boolFromJson, toJson: boolToJson) bool? get active;@JsonKey(name: 'is_free', fromJson: boolFromJson, toJson: boolToJson) bool? get isFree; String? get url;@JsonKey(name: 'shipping_handling', fromJson: boolFromJson, toJson: boolToJson) bool? get shippingHandling;@JsonKey(name: 'shipping_external') String? get shippingExternal;@JsonKey(name: 'range_behavior', fromJson: boolFromJson, toJson: boolToJson) bool? get rangeBehavior;@JsonKey(name: 'shipping_method', fromJson: intFromJson) int? get shippingMethod;@JsonKey(name: 'max_width', fromJson: nullableIntFromJson) int? get maxWidth;@JsonKey(name: 'max_height', fromJson: nullableIntFromJson) int? get maxHeight;@JsonKey(name: 'max_depth', fromJson: nullableIntFromJson) int? get maxDepth;@JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson) double? get maxWeight;@JsonKey(fromJson: nullableIntFromJson) int? get grade;@JsonKey(name: 'external_module_name') String? get externalModuleName;@JsonKey(name: 'need_range') String? get needRange; String? get position; String? get delay;
...
@useResult
$Res call({
 int? id,@JsonKey(fromJson: boolFromJson, toJson: boolToJson) bool? deleted,@JsonKey(name: 'is_module', fromJson: boolFromJson, toJson: boolToJson) bool? isModule,@JsonKey(name: 'id_tax_rules_group') String? idTaxRulesGroup,@JsonKey(name: 'id_reference') String? idReference, String? name,@JsonKey(fromJson: boolFromJson, toJson: boolToJson) bool? active,@JsonKey(name: 'is_free', fromJson: boolFromJson, toJson: boolToJson) bool? isFree, String? url,@JsonKey(name: 'shipping_handling', fromJson: boolFromJson, toJson: boolToJson) bool? shippingHandling,@JsonKey(name: 'shipping_external') String? shippingExternal,@JsonKey(name: 'range_behavior', fromJson: boolFromJson, toJson: boolToJson) bool? rangeBehavior,@JsonKey(name: 'shipping_method', fromJson: intFromJson) int? shippingMethod,@JsonKey(name: 'max_width', fromJson: nullableIntFromJson) int? maxWidth,@JsonKey(name: 'max_height', fromJson: nullableIntFromJson) int? maxHeight,@JsonKey(name: 'max_depth', fromJson: nullableIntFromJson) int? maxDepth,@JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson) double? maxWeight,@JsonKey(fromJson: nullableIntFromJson) int? grade,@JsonKey(name: 'external_module_name') String? externalModuleName,@JsonKey(name: 'need_range') String? needRange, String? position, String? delay
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: boolFromJson, toJson: boolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: boolFromJson, toJson: boolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group')  String? idTaxRulesGroup, @JsonKey(name: 'id_reference')  String? idReference,  String? name, @JsonKey(fromJson: boolFromJson, toJson: boolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: boolFromJson, toJson: boolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: boolFromJson, toJson: boolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external')  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: boolFromJson, toJson: boolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: intFromJson)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: nullableIntFromJson)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: nullableIntFromJson)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: nullableIntFromJson)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson)  double? maxWeight, @JsonKey(fromJson: nullableIntFromJson)  int? grade, @JsonKey(name: 'external_module_name')  String? externalModuleName, @JsonKey(name: 'need_range')  String? needRange,  String? position,  String? delay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CarrierDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: boolFromJson, toJson: boolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: boolFromJson, toJson: boolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group')  String? idTaxRulesGroup, @JsonKey(name: 'id_reference')  String? idReference,  String? name, @JsonKey(fromJson: boolFromJson, toJson: boolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: boolFromJson, toJson: boolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: boolFromJson, toJson: boolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external')  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: boolFromJson, toJson: boolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: intFromJson)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: nullableIntFromJson)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: nullableIntFromJson)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: nullableIntFromJson)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson)  double? maxWeight, @JsonKey(fromJson: nullableIntFromJson)  int? grade, @JsonKey(name: 'external_module_name')  String? externalModuleName, @JsonKey(name: 'need_range')  String? needRange,  String? position,  String? delay)  $default,) {final _that = this;
switch (_that) {
case _CarrierDTO():
return $default(_that.id,_that.deleted,_that.isModule,_that.idTaxRulesGroup,_that.idReference,_that.name,_that.active,_that.isFree,_that.url,_that.shippingHandling,_that.shippingExternal,_that.rangeBehavior,_that.shippingMethod,_that.maxWidth,_that.maxHeight,_that.maxDepth,_that.maxWeight,_that.grade,_that.externalModuleName,_that.needRange,_that.position,_that.delay);case _:
  throw StateError('Unexpected subclass');
...
class _CarrierDTO extends CarrierDTO {
  const _CarrierDTO({this.id, @JsonKey(fromJson: boolFromJson, toJson: boolToJson) this.deleted, @JsonKey(name: 'is_module', fromJson: boolFromJson, toJson: boolToJson) this.isModule, @JsonKey(name: 'id_tax_rules_group') this.idTaxRulesGroup, @JsonKey(name: 'id_reference') this.idReference, this.name, @JsonKey(fromJson: boolFromJson, toJson: boolToJson) this.active, @JsonKey(name: 'is_free', fromJson: boolFromJson, toJson: boolToJson) this.isFree, this.url, @JsonKey(name: 'shipping_handling', fromJson: boolFromJson, toJson: boolToJson) this.shippingHandling, @JsonKey(name: 'shipping_external') this.shippingExternal, @JsonKey(name: 'range_behavior', fromJson: boolFromJson, toJson: boolToJson) this.rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: intFromJson) this.shippingMethod, @JsonKey(name: 'max_width', fromJson: nullableIntFromJson) this.maxWidth, @JsonKey(name: 'max_height', fromJson: nullableIntFromJson) this.maxHeight, @JsonKey(name: 'max_depth', fromJson: nullableIntFromJson) this.maxDepth, @JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson) this.maxWeight, @JsonKey(fromJson: nullableIntFromJson) this.grade, @JsonKey(name: 'external_module_name') this.externalModuleName, @JsonKey(name: 'need_range') this.needRange, this.position, this.delay}): super._();
...
@override@JsonKey(name: 'id_tax_rules_group') final  String? idTaxRulesGroup;
...
@override@JsonKey(name: 'shipping_external') final  String? shippingExternal;
...
@override@JsonKey(name: 'max_width', fromJson: nullableIntFromJson) final  int? maxWidth;
@override@JsonKey(name: 'max_height', fromJson: nullableIntFromJson) final  int? maxHeight;
@override@JsonKey(name: 'max_depth', fromJson: nullableIntFromJson) final  int? maxDepth;
@override@JsonKey(name: 'max_weight', fromJson: nullableDoubleFromJson) final  double? maxWeight;
@override@JsonKey(fromJson: nullableIntFromJson) final  int? grade;
@override@JsonKey(name: 'external_module_name') final  String? externalModuleName;
@override@JsonKey(name: 'need_range') final  String? needRange;
