...
mixin _$CarrierDTO {
 ...
 int? get id;@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? get deleted;@JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson) bool? get isModule;@JsonKey(name: 'id_tax_rules_group') String? get idTaxRulesGroup;@JsonKey(name: 'id_reference') String? get idReference; String? get name;@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? get active;@JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson) bool? get isFree; String? get url;@JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson) bool? get shippingHandling;@JsonKey(name: 'shipping_external') String? get shippingExternal;@JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson) bool? get rangeBehavior;@JsonKey(name: 'shipping_method', fromJson: parseUnsignedId) int? get shippingMethod;@JsonKey(name: 'max_width', fromJson: parseUnsignedId) int? get maxWidth;@JsonKey(name: 'max_height', fromJson: parseUnsignedId) int? get maxHeight;@JsonKey(name: 'max_depth', fromJson: parseUnsignedId) int? get maxDepth;@JsonKey(name: 'max_weight', fromJson: parseIsFloat) double? get maxWeight;@JsonKey(fromJson: parseUnsignedId) int? get grade;@JsonKey(name: 'external_module_name') String? get externalModuleName;@JsonKey(name: 'need_range') String? get needRange; String? get position; String? get delay;
...
@useResult
$Res call({
 int? id,@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? deleted,@JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson) bool? isModule,@JsonKey(name: 'id_tax_rules_group') String? idTaxRulesGroup,@JsonKey(name: 'id_reference') String? idReference, String? name,@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? active,@JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson) bool? isFree, String? url,@JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson) bool? shippingHandling,@JsonKey(name: 'shipping_external') String? shippingExternal,@JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson) bool? rangeBehavior,@JsonKey(name: 'shipping_method', fromJson: parseUnsignedId) int? shippingMethod,@JsonKey(name: 'max_width', fromJson: parseUnsignedId) int? maxWidth,@JsonKey(name: 'max_height', fromJson: parseUnsignedId) int? maxHeight,@JsonKey(name: 'max_depth', fromJson: parseUnsignedId) int? maxDepth,@JsonKey(name: 'max_weight', fromJson: parseIsFloat) double? maxWeight,@JsonKey(fromJson: parseUnsignedId) int? grade,@JsonKey(name: 'external_module_name') String? externalModuleName,@JsonKey(name: 'need_range') String? needRange, String? position, String? delay
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group')  String? idTaxRulesGroup, @JsonKey(name: 'id_reference')  String? idReference,  String? name, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external')  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: parseUnsignedId)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: parseUnsignedId)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: parseUnsignedId)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: parseUnsignedId)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: parseIsFloat)  double? maxWeight, @JsonKey(fromJson: parseUnsignedId)  int? grade, @JsonKey(name: 'external_module_name')  String? externalModuleName, @JsonKey(name: 'need_range')  String? needRange,  String? position,  String? delay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CarrierDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group')  String? idTaxRulesGroup, @JsonKey(name: 'id_reference')  String? idReference,  String? name, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external')  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: parseUnsignedId)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: parseUnsignedId)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: parseUnsignedId)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: parseUnsignedId)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: parseIsFloat)  double? maxWeight, @JsonKey(fromJson: parseUnsignedId)  int? grade, @JsonKey(name: 'external_module_name')  String? externalModuleName, @JsonKey(name: 'need_range')  String? needRange,  String? position,  String? delay)  $default,) {final _that = this;
switch (_that) {
case _CarrierDTO():
return $default(_that.id,_that.deleted,_that.isModule,_that.idTaxRulesGroup,_that.idReference,_that.name,_that.active,_that.isFree,_that.url,_that.shippingHandling,_that.shippingExternal,_that.rangeBehavior,_that.shippingMethod,_that.maxWidth,_that.maxHeight,_that.maxDepth,_that.maxWeight,_that.grade,_that.externalModuleName,_that.needRange,_that.position,_that.delay);case _:
  throw StateError('Unexpected subclass');
...
class _CarrierDTO extends CarrierDTO {
  const _CarrierDTO({this.id, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.deleted, @JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson) this.isModule, @JsonKey(name: 'id_tax_rules_group') this.idTaxRulesGroup, @JsonKey(name: 'id_reference') this.idReference, this.name, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.active, @JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson) this.isFree, this.url, @JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson) this.shippingHandling, @JsonKey(name: 'shipping_external') this.shippingExternal, @JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson) this.rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: parseUnsignedId) this.shippingMethod, @JsonKey(name: 'max_width', fromJson: parseUnsignedId) this.maxWidth, @JsonKey(name: 'max_height', fromJson: parseUnsignedId) this.maxHeight, @JsonKey(name: 'max_depth', fromJson: parseUnsignedId) this.maxDepth, @JsonKey(name: 'max_weight', fromJson: parseIsFloat) this.maxWeight, @JsonKey(fromJson: parseUnsignedId) this.grade, @JsonKey(name: 'external_module_name') this.externalModuleName, @JsonKey(name: 'need_range') this.needRange, this.position, this.delay}): super._();
...
@override@JsonKey(name: 'shipping_method', fromJson: parseUnsignedId) final  int? shippingMethod;
@override@JsonKey(name: 'max_width', fromJson: parseUnsignedId) final  int? maxWidth;
@override@JsonKey(name: 'max_height', fromJson: parseUnsignedId) final  int? maxHeight;
@override@JsonKey(name: 'max_depth', fromJson: parseUnsignedId) final  int? maxDepth;
@override@JsonKey(name: 'max_weight', fromJson: parseIsFloat) final  double? maxWeight;
@override@JsonKey(fromJson: parseUnsignedId) final  int? grade;
