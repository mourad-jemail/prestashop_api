...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group', fromJson: stringFromDynamicJson)  String? idTaxRulesGroup, @JsonKey(name: 'id_reference', fromJson: stringFromDynamicJson)  String? idReference,  String? name, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external', fromJson: stringFromDynamicJson)  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: parseNullOrUnsignedId)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: parseNullOrUnsignedId)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: parseNullOrUnsignedId)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: parseNullOrUnsignedId)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: parseIsFloat, toJson: isFloatToJson)  double? maxWeight, @JsonKey(fromJson: parseNullOrUnsignedId)  int? grade, @JsonKey(name: 'external_module_name', fromJson: stringFromDynamicJson)  String? externalModuleName, @JsonKey(name: 'need_range', fromJson: stringFromDynamicJson)  String? needRange, @JsonKey(fromJson: stringFromDynamicJson)  String? position,  String? delay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CarrierDTO() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? deleted, @JsonKey(name: 'is_module', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isModule, @JsonKey(name: 'id_tax_rules_group', fromJson: stringFromDynamicJson)  String? idTaxRulesGroup, @JsonKey(name: 'id_reference', fromJson: stringFromDynamicJson)  String? idReference,  String? name, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'is_free', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isFree,  String? url, @JsonKey(name: 'shipping_handling', fromJson: parseIsBool, toJson: isBoolToJson)  bool? shippingHandling, @JsonKey(name: 'shipping_external', fromJson: stringFromDynamicJson)  String? shippingExternal, @JsonKey(name: 'range_behavior', fromJson: parseIsBool, toJson: isBoolToJson)  bool? rangeBehavior, @JsonKey(name: 'shipping_method', fromJson: parseNullOrUnsignedId)  int? shippingMethod, @JsonKey(name: 'max_width', fromJson: parseNullOrUnsignedId)  int? maxWidth, @JsonKey(name: 'max_height', fromJson: parseNullOrUnsignedId)  int? maxHeight, @JsonKey(name: 'max_depth', fromJson: parseNullOrUnsignedId)  int? maxDepth, @JsonKey(name: 'max_weight', fromJson: parseIsFloat, toJson: isFloatToJson)  double? maxWeight, @JsonKey(fromJson: parseNullOrUnsignedId)  int? grade, @JsonKey(name: 'external_module_name', fromJson: stringFromDynamicJson)  String? externalModuleName, @JsonKey(name: 'need_range', fromJson: stringFromDynamicJson)  String? needRange, @JsonKey(fromJson: stringFromDynamicJson)  String? position,  String? delay)  $default,) {final _that = this;
switch (_that) {
case _CarrierDTO():
return $default(_that.id,_that.deleted,_that.isModule,_that.idTaxRulesGroup,_that.idReference,_that.name,_that.active,_that.isFree,_that.url,_that.shippingHandling,_that.shippingExternal,_that.rangeBehavior,_that.shippingMethod,_that.maxWidth,_that.maxHeight,_that.maxDepth,_that.maxWeight,_that.grade,_that.externalModuleName,_that.needRange,_that.position,_that.delay);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey(name: 'max_weight', fromJson: parseIsFloat, toJson: isFloatToJson) final  double? maxWeight;
