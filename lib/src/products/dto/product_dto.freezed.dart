...
mixin _$ProductDTO {
 ...
 int? get id;@JsonKey(name: 'id_manufacturer', fromJson: parseUnsignedId) int? get idManufacturer;@JsonKey(name: 'id_supplier', fromJson: parseUnsignedId) int? get idSupplier;@JsonKey(name: 'id_category_default', fromJson: parseUnsignedId) int? get idDefaultCategory; String? get new_;@JsonKey(name: 'cache_default_attribute') String? get cacheDefaultAttribute;@JsonKey(name: 'id_default_image') String? get idDefaultImage;@JsonKey(name: 'id_default_combination', fromJson: stringFromDynamicJson) String? get idDefaultCombination;@JsonKey(name: 'id_tax_rules_group', fromJson: parseUnsignedId) int? get idTaxRulesGroup;@JsonKey(name: 'position_in_category') String? get positionInCategory;@JsonKey(name: 'manufacturer_name', fromJson: stringFromDynamicJson) String? get manufacturerName; String? get quantity; String? get type;@JsonKey(name: 'id_shop_default', fromJson: parseUnsignedId) int? get idShopDefault; String? get reference;@JsonKey(name: 'supplier_reference') String? get supplierReference; String? get location;@JsonKey(fromJson: parseIsFloat) double? get width;@JsonKey(fromJson: parseIsFloat) double? get height;@JsonKey(fromJson: parseIsFloat) double? get depth;@JsonKey(fromJson: parseIsFloat) double? get weight;@JsonKey(name: 'quantity_discount', fromJson: parseIsBool, toJson: isBoolToJson) bool? get quantityDiscount; String? get ean13; String? get isbn; String? get upc; String? get mpn;@JsonKey(name: 'cache_is_pack', fromJson: parseIsBool, toJson: isBoolToJson) bool? get cacheIsPack;@JsonKey(name: 'cache_has_attachments', fromJson: parseIsBool, toJson: isBoolToJson) bool? get cacheHasAttachments;@JsonKey(name: 'is_virtual', fromJson: parseIsBool, toJson: isBoolToJson) bool? get isVirtual;@JsonKey(fromJson: parseUnsignedId) int? get state;@JsonKey(name: 'additional_delivery_times', fromJson: parseUnsignedId) int? get additionalDeliveryTimes;@JsonKey(name: 'delivery_in_stock') String? get deliveryInStock;@JsonKey(name: 'delivery_out_stock') String? get deliveryOutStock;@JsonKey(name: 'on_sale', fromJson: parseIsBool, toJson: isBoolToJson) bool? get onSale;@JsonKey(name: 'online_only', fromJson: parseIsBool, toJson: isBoolToJson) bool? get onlineOnly;@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) double? get ecotax;@JsonKey(name: 'minimal_quantity', fromJson: parseUnsignedId) int? get minimalQuantity;@JsonKey(name: 'low_stock_threshold', fromJson: stringFromJson) String? get lowStockThreshold;@JsonKey(name: 'low_stock_alert', fromJson: parseIsBool, toJson: isBoolToJson) bool? get lowStockAlert;@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) double? get price;@JsonKey(name: 'wholesale_price', fromJson: parseIsFloat, toJson: isFloatToJson) double? get wholesalePrice;@JsonKey(fromJson: stringFromJson) String? get unity;@JsonKey(name: 'unit_price_ratio') String? get unitPriceRatio;@JsonKey(name: 'additional_shipping_cost', fromJson: parseIsFloat, toJson: isFloatToJson) double? get additionalShippingCost;@JsonKey(fromJson: parseUnsignedId) int? get customizable;@JsonKey(name: 'text_fields', fromJson: parseUnsignedId) int? get textFields;@JsonKey(name: 'uploadable_files', fromJson: parseUnsignedId) int? get uploadableFiles;@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? get active;@JsonKey(name: 'redirect_type') String? get redirectType;@JsonKey(name: 'id_type_redirected', fromJson: parseUnsignedId) int? get idTypeRedirected;@JsonKey(name: 'available_for_order', fromJson: parseIsBool, toJson: isBoolToJson) bool? get availableForOrder;@JsonKey(name: 'available_date', fromJson: parseIsDate) DateTime? get availableDate;@JsonKey(name: 'show_condition', fromJson: parseIsBool, toJson: isBoolToJson) bool? get showCondition; String? get condition;@JsonKey(name: 'show_price', fromJson: parseIsBool, toJson: isBoolToJson) bool? get showPrice;@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? get indexed; String? get visibility;@JsonKey(name: 'advanced_stock_management', fromJson: parseIsBool, toJson: isBoolToJson) bool? get advancedStockManagement;@JsonKey(name: 'date_add', fromJson: parseIsDate) DateTime? get dateAdd;@JsonKey(name: 'date_upd', fromJson: parseIsDate) DateTime? get dateUpd;@JsonKey(name: 'pack_stock_type', fromJson: parseUnsignedId) int? get packStockType;@JsonKey(name: 'meta_description') String? get metaDescription;@JsonKey(name: 'meta_keywords') String? get metaKeywords;@JsonKey(name: 'meta_title') String? get metaTitle;@JsonKey(name: 'link_rewrite') String? get linkRewrite; String? get name; String? get description;@JsonKey(name: 'description_short') String? get descriptionShort;@JsonKey(name: 'available_now') String? get availableNow;@JsonKey(name: 'available_later') String? get availableLater;@JsonKey(name: 'price_tax_incl') String? get priceTaxIncluded;@JsonKey(name: 'price_tax_excl') String? get priceTaxExcluded;@JsonKey(fromJson: _associationsDTOFromJson) ProductAssociationsDTO? get associations;
...
@useResult
$Res call({
 int? id,@JsonKey(name: 'id_manufacturer', fromJson: parseUnsignedId) int? idManufacturer,@JsonKey(name: 'id_supplier', fromJson: parseUnsignedId) int? idSupplier,@JsonKey(name: 'id_category_default', fromJson: parseUnsignedId) int? idDefaultCategory, String? new_,@JsonKey(name: 'cache_default_attribute') String? cacheDefaultAttribute,@JsonKey(name: 'id_default_image') String? idDefaultImage,@JsonKey(name: 'id_default_combination', fromJson: stringFromDynamicJson) String? idDefaultCombination,@JsonKey(name: 'id_tax_rules_group', fromJson: parseUnsignedId) int? idTaxRulesGroup,@JsonKey(name: 'position_in_category') String? positionInCategory,@JsonKey(name: 'manufacturer_name', fromJson: stringFromDynamicJson) String? manufacturerName, String? quantity, String? type,@JsonKey(name: 'id_shop_default', fromJson: parseUnsignedId) int? idShopDefault, String? reference,@JsonKey(name: 'supplier_reference') String? supplierReference, String? location,@JsonKey(fromJson: parseIsFloat) double? width,@JsonKey(fromJson: parseIsFloat) double? height,@JsonKey(fromJson: parseIsFloat) double? depth,@JsonKey(fromJson: parseIsFloat) double? weight,@JsonKey(name: 'quantity_discount', fromJson: parseIsBool, toJson: isBoolToJson) bool? quantityDiscount, String? ean13, String? isbn, String? upc, String? mpn,@JsonKey(name: 'cache_is_pack', fromJson: parseIsBool, toJson: isBoolToJson) bool? cacheIsPack,@JsonKey(name: 'cache_has_attachments', fromJson: parseIsBool, toJson: isBoolToJson) bool? cacheHasAttachments,@JsonKey(name: 'is_virtual', fromJson: parseIsBool, toJson: isBoolToJson) bool? isVirtual,@JsonKey(fromJson: parseUnsignedId) int? state,@JsonKey(name: 'additional_delivery_times', fromJson: parseUnsignedId) int? additionalDeliveryTimes,@JsonKey(name: 'delivery_in_stock') String? deliveryInStock,@JsonKey(name: 'delivery_out_stock') String? deliveryOutStock,@JsonKey(name: 'on_sale', fromJson: parseIsBool, toJson: isBoolToJson) bool? onSale,@JsonKey(name: 'online_only', fromJson: parseIsBool, toJson: isBoolToJson) bool? onlineOnly,@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) double? ecotax,@JsonKey(name: 'minimal_quantity', fromJson: parseUnsignedId) int? minimalQuantity,@JsonKey(name: 'low_stock_threshold', fromJson: stringFromJson) String? lowStockThreshold,@JsonKey(name: 'low_stock_alert', fromJson: parseIsBool, toJson: isBoolToJson) bool? lowStockAlert,@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) double? price,@JsonKey(name: 'wholesale_price', fromJson: parseIsFloat, toJson: isFloatToJson) double? wholesalePrice,@JsonKey(fromJson: stringFromJson) String? unity,@JsonKey(name: 'unit_price_ratio') String? unitPriceRatio,@JsonKey(name: 'additional_shipping_cost', fromJson: parseIsFloat, toJson: isFloatToJson) double? additionalShippingCost,@JsonKey(fromJson: parseUnsignedId) int? customizable,@JsonKey(name: 'text_fields', fromJson: parseUnsignedId) int? textFields,@JsonKey(name: 'uploadable_files', fromJson: parseUnsignedId) int? uploadableFiles,@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? active,@JsonKey(name: 'redirect_type') String? redirectType,@JsonKey(name: 'id_type_redirected', fromJson: parseUnsignedId) int? idTypeRedirected,@JsonKey(name: 'available_for_order', fromJson: parseIsBool, toJson: isBoolToJson) bool? availableForOrder,@JsonKey(name: 'available_date', fromJson: parseIsDate) DateTime? availableDate,@JsonKey(name: 'show_condition', fromJson: parseIsBool, toJson: isBoolToJson) bool? showCondition, String? condition,@JsonKey(name: 'show_price', fromJson: parseIsBool, toJson: isBoolToJson) bool? showPrice,@JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) bool? indexed, String? visibility,@JsonKey(name: 'advanced_stock_management', fromJson: parseIsBool, toJson: isBoolToJson) bool? advancedStockManagement,@JsonKey(name: 'date_add', fromJson: parseIsDate) DateTime? dateAdd,@JsonKey(name: 'date_upd', fromJson: parseIsDate) DateTime? dateUpd,@JsonKey(name: 'pack_stock_type', fromJson: parseUnsignedId) int? packStockType,@JsonKey(name: 'meta_description') String? metaDescription,@JsonKey(name: 'meta_keywords') String? metaKeywords,@JsonKey(name: 'meta_title') String? metaTitle,@JsonKey(name: 'link_rewrite') String? linkRewrite, String? name, String? description,@JsonKey(name: 'description_short') String? descriptionShort,@JsonKey(name: 'available_now') String? availableNow,@JsonKey(name: 'available_later') String? availableLater,@JsonKey(name: 'price_tax_incl') String? priceTaxIncluded,@JsonKey(name: 'price_tax_excl') String? priceTaxExcluded,@JsonKey(fromJson: _associationsDTOFromJson) ProductAssociationsDTO? associations
});
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id, @JsonKey(name: 'id_manufacturer', fromJson: parseUnsignedId)  int? idManufacturer, @JsonKey(name: 'id_supplier', fromJson: parseUnsignedId)  int? idSupplier, @JsonKey(name: 'id_category_default', fromJson: parseUnsignedId)  int? idDefaultCategory,  String? new_, @JsonKey(name: 'cache_default_attribute')  String? cacheDefaultAttribute, @JsonKey(name: 'id_default_image')  String? idDefaultImage, @JsonKey(name: 'id_default_combination', fromJson: stringFromDynamicJson)  String? idDefaultCombination, @JsonKey(name: 'id_tax_rules_group', fromJson: parseUnsignedId)  int? idTaxRulesGroup, @JsonKey(name: 'position_in_category')  String? positionInCategory, @JsonKey(name: 'manufacturer_name', fromJson: stringFromDynamicJson)  String? manufacturerName,  String? quantity,  String? type, @JsonKey(name: 'id_shop_default', fromJson: parseUnsignedId)  int? idShopDefault,  String? reference, @JsonKey(name: 'supplier_reference')  String? supplierReference,  String? location, @JsonKey(fromJson: parseIsFloat)  double? width, @JsonKey(fromJson: parseIsFloat)  double? height, @JsonKey(fromJson: parseIsFloat)  double? depth, @JsonKey(fromJson: parseIsFloat)  double? weight, @JsonKey(name: 'quantity_discount', fromJson: parseIsBool, toJson: isBoolToJson)  bool? quantityDiscount,  String? ean13,  String? isbn,  String? upc,  String? mpn, @JsonKey(name: 'cache_is_pack', fromJson: parseIsBool, toJson: isBoolToJson)  bool? cacheIsPack, @JsonKey(name: 'cache_has_attachments', fromJson: parseIsBool, toJson: isBoolToJson)  bool? cacheHasAttachments, @JsonKey(name: 'is_virtual', fromJson: parseIsBool, toJson: isBoolToJson)  bool? isVirtual, @JsonKey(fromJson: parseUnsignedId)  int? state, @JsonKey(name: 'additional_delivery_times', fromJson: parseUnsignedId)  int? additionalDeliveryTimes, @JsonKey(name: 'delivery_in_stock')  String? deliveryInStock, @JsonKey(name: 'delivery_out_stock')  String? deliveryOutStock, @JsonKey(name: 'on_sale', fromJson: parseIsBool, toJson: isBoolToJson)  bool? onSale, @JsonKey(name: 'online_only', fromJson: parseIsBool, toJson: isBoolToJson)  bool? onlineOnly, @JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson)  double? ecotax, @JsonKey(name: 'minimal_quantity', fromJson: parseUnsignedId)  int? minimalQuantity, @JsonKey(name: 'low_stock_threshold', fromJson: stringFromJson)  String? lowStockThreshold, @JsonKey(name: 'low_stock_alert', fromJson: parseIsBool, toJson: isBoolToJson)  bool? lowStockAlert, @JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson)  double? price, @JsonKey(name: 'wholesale_price', fromJson: parseIsFloat, toJson: isFloatToJson)  double? wholesalePrice, @JsonKey(fromJson: stringFromJson)  String? unity, @JsonKey(name: 'unit_price_ratio')  String? unitPriceRatio, @JsonKey(name: 'additional_shipping_cost', fromJson: parseIsFloat, toJson: isFloatToJson)  double? additionalShippingCost, @JsonKey(fromJson: parseUnsignedId)  int? customizable, @JsonKey(name: 'text_fields', fromJson: parseUnsignedId)  int? textFields, @JsonKey(name: 'uploadable_files', fromJson: parseUnsignedId)  int? uploadableFiles, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? active, @JsonKey(name: 'redirect_type')  String? redirectType, @JsonKey(name: 'id_type_redirected', fromJson: parseUnsignedId)  int? idTypeRedirected, @JsonKey(name: 'available_for_order', fromJson: parseIsBool, toJson: isBoolToJson)  bool? availableForOrder, @JsonKey(name: 'available_date', fromJson: parseIsDate)  DateTime? availableDate, @JsonKey(name: 'show_condition', fromJson: parseIsBool, toJson: isBoolToJson)  bool? showCondition,  String? condition, @JsonKey(name: 'show_price', fromJson: parseIsBool, toJson: isBoolToJson)  bool? showPrice, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson)  bool? indexed,  String? visibility, @JsonKey(name: 'advanced_stock_management', fromJson: parseIsBool, toJson: isBoolToJson)  bool? advancedStockManagement, @JsonKey(name: 'date_add', fromJson: parseIsDate)  DateTime? dateAdd, @JsonKey(name: 'date_upd', fromJson: parseIsDate)  DateTime? dateUpd, @JsonKey(name: 'pack_stock_type', fromJson: parseUnsignedId)  int? packStockType, @JsonKey(name: 'meta_description')  String? metaDescription, @JsonKey(name: 'meta_keywords')  String? metaKeywords, @JsonKey(name: 'meta_title')  String? metaTitle, @JsonKey(name: 'link_rewrite')  String? linkRewrite,  String? name,  String? description, @JsonKey(name: 'description_short')  String? descriptionShort, @JsonKey(name: 'available_now')  String? availableNow, @JsonKey(name: 'available_later')  String? availableLater, @JsonKey(name: 'price_tax_incl')  String? priceTaxIncluded, @JsonKey(name: 'price_tax_excl')  String? priceTaxExcluded, @JsonKey(fromJson: _associationsDTOFromJson)  ProductAssociationsDTO? associations)?  $default,) {final _that = this;
switch (_that) {
case _ProductDTO() when $default != null:
return $default(_that.id,_that.idManufacturer,_that.idSupplier,_that.idDefaultCategory,_that.new_,_that.cacheDefaultAttribute,_that.idDefaultImage,_that.idDefaultCombination,_that.idTaxRulesGroup,_that.positionInCategory,_that.manufacturerName,_that.quantity,_that.type,_that.idShopDefault,_that.reference,_that.supplierReference,_that.location,_that.width,_that.height,_that.depth,_that.weight,_that.quantityDiscount,_that.ean13,_that.isbn,_that.upc,_that.mpn,_that.cacheIsPack,_that.cacheHasAttachments,_that.isVirtual,_that.state,_that.additionalDeliveryTimes,_that.deliveryInStock,_that.deliveryOutStock,_that.onSale,_that.onlineOnly,_that.ecotax,_that.minimalQuantity,_that.lowStockThreshold,_that.lowStockAlert,_that.price,_that.wholesalePrice,_that.unity,_that.unitPriceRatio,_that.additionalShippingCost,_that.customizable,_that.textFields,_that.uploadableFiles,_that.active,_that.redirectType,_that.idTypeRedirected,_that.availableForOrder,_that.availableDate,_that.showCondition,_that.condition,_that.showPrice,_that.indexed,_that.visibility,_that.advancedStockManagement,_that.dateAdd,_that.dateUpd,_that.packStockType,_that.metaDescription,_that.metaKeywords,_that.metaTitle,_that.linkRewrite,_that.name,_that.description,_that.descriptionShort,_that.availableNow,_that.availableLater,_that.priceTaxIncluded,_that.priceTaxExcluded,_that.associations);case _:
  return null;
...
class _ProductDTO extends ProductDTO {
  const _ProductDTO({this.id, @JsonKey(name: 'id_manufacturer', fromJson: parseUnsignedId) this.idManufacturer, @JsonKey(name: 'id_supplier', fromJson: parseUnsignedId) this.idSupplier, @JsonKey(name: 'id_category_default', fromJson: parseUnsignedId) this.idDefaultCategory, this.new_, @JsonKey(name: 'cache_default_attribute') this.cacheDefaultAttribute, @JsonKey(name: 'id_default_image') this.idDefaultImage, @JsonKey(name: 'id_default_combination', fromJson: stringFromDynamicJson) this.idDefaultCombination, @JsonKey(name: 'id_tax_rules_group', fromJson: parseUnsignedId) this.idTaxRulesGroup, @JsonKey(name: 'position_in_category') this.positionInCategory, @JsonKey(name: 'manufacturer_name', fromJson: stringFromDynamicJson) this.manufacturerName, this.quantity, this.type, @JsonKey(name: 'id_shop_default', fromJson: parseUnsignedId) this.idShopDefault, this.reference, @JsonKey(name: 'supplier_reference') this.supplierReference, this.location, @JsonKey(fromJson: parseIsFloat) this.width, @JsonKey(fromJson: parseIsFloat) this.height, @JsonKey(fromJson: parseIsFloat) this.depth, @JsonKey(fromJson: parseIsFloat) this.weight, @JsonKey(name: 'quantity_discount', fromJson: parseIsBool, toJson: isBoolToJson) this.quantityDiscount, this.ean13, this.isbn, this.upc, this.mpn, @JsonKey(name: 'cache_is_pack', fromJson: parseIsBool, toJson: isBoolToJson) this.cacheIsPack, @JsonKey(name: 'cache_has_attachments', fromJson: parseIsBool, toJson: isBoolToJson) this.cacheHasAttachments, @JsonKey(name: 'is_virtual', fromJson: parseIsBool, toJson: isBoolToJson) this.isVirtual, @JsonKey(fromJson: parseUnsignedId) this.state, @JsonKey(name: 'additional_delivery_times', fromJson: parseUnsignedId) this.additionalDeliveryTimes, @JsonKey(name: 'delivery_in_stock') this.deliveryInStock, @JsonKey(name: 'delivery_out_stock') this.deliveryOutStock, @JsonKey(name: 'on_sale', fromJson: parseIsBool, toJson: isBoolToJson) this.onSale, @JsonKey(name: 'online_only', fromJson: parseIsBool, toJson: isBoolToJson) this.onlineOnly, @JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) this.ecotax, @JsonKey(name: 'minimal_quantity', fromJson: parseUnsignedId) this.minimalQuantity, @JsonKey(name: 'low_stock_threshold', fromJson: stringFromJson) this.lowStockThreshold, @JsonKey(name: 'low_stock_alert', fromJson: parseIsBool, toJson: isBoolToJson) this.lowStockAlert, @JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) this.price, @JsonKey(name: 'wholesale_price', fromJson: parseIsFloat, toJson: isFloatToJson) this.wholesalePrice, @JsonKey(fromJson: stringFromJson) this.unity, @JsonKey(name: 'unit_price_ratio') this.unitPriceRatio, @JsonKey(name: 'additional_shipping_cost', fromJson: parseIsFloat, toJson: isFloatToJson) this.additionalShippingCost, @JsonKey(fromJson: parseUnsignedId) this.customizable, @JsonKey(name: 'text_fields', fromJson: parseUnsignedId) this.textFields, @JsonKey(name: 'uploadable_files', fromJson: parseUnsignedId) this.uploadableFiles, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.active, @JsonKey(name: 'redirect_type') this.redirectType, @JsonKey(name: 'id_type_redirected', fromJson: parseUnsignedId) this.idTypeRedirected, @JsonKey(name: 'available_for_order', fromJson: parseIsBool, toJson: isBoolToJson) this.availableForOrder, @JsonKey(name: 'available_date', fromJson: parseIsDate) this.availableDate, @JsonKey(name: 'show_condition', fromJson: parseIsBool, toJson: isBoolToJson) this.showCondition, this.condition, @JsonKey(name: 'show_price', fromJson: parseIsBool, toJson: isBoolToJson) this.showPrice, @JsonKey(fromJson: parseIsBool, toJson: isBoolToJson) this.indexed, this.visibility, @JsonKey(name: 'advanced_stock_management', fromJson: parseIsBool, toJson: isBoolToJson) this.advancedStockManagement, @JsonKey(name: 'date_add', fromJson: parseIsDate) this.dateAdd, @JsonKey(name: 'date_upd', fromJson: parseIsDate) this.dateUpd, @JsonKey(name: 'pack_stock_type', fromJson: parseUnsignedId) this.packStockType, @JsonKey(name: 'meta_description') this.metaDescription, @JsonKey(name: 'meta_keywords') this.metaKeywords, @JsonKey(name: 'meta_title') this.metaTitle, @JsonKey(name: 'link_rewrite') this.linkRewrite, this.name, this.description, @JsonKey(name: 'description_short') this.descriptionShort, @JsonKey(name: 'available_now') this.availableNow, @JsonKey(name: 'available_later') this.availableLater, @JsonKey(name: 'price_tax_incl') this.priceTaxIncluded, @JsonKey(name: 'price_tax_excl') this.priceTaxExcluded, @JsonKey(fromJson: _associationsDTOFromJson) this.associations}): super._();
  factory _ProductDTO.fromJson(Map<String, dynamic> json) => _$ProductDTOFromJson(json);

@override final  int? id;
@override@JsonKey(name: 'id_manufacturer', fromJson: parseUnsignedId) final  int? idManufacturer;
@override@JsonKey(name: 'id_supplier', fromJson: parseUnsignedId) final  int? idSupplier;
@override@JsonKey(name: 'id_category_default', fromJson: parseUnsignedId) final  int? idDefaultCategory;
@override final  String? new_;
@override@JsonKey(name: 'cache_default_attribute') final  String? cacheDefaultAttribute;
@override@JsonKey(name: 'id_default_image') final  String? idDefaultImage;
@override@JsonKey(name: 'id_default_combination', fromJson: stringFromDynamicJson) final  String? idDefaultCombination;
@override@JsonKey(name: 'id_tax_rules_group', fromJson: parseUnsignedId) final  int? idTaxRulesGroup;
@override@JsonKey(name: 'position_in_category') final  String? positionInCategory;
@override@JsonKey(name: 'manufacturer_name', fromJson: stringFromDynamicJson) final  String? manufacturerName;
@override final  String? quantity;
@override final  String? type;
@override@JsonKey(name: 'id_shop_default', fromJson: parseUnsignedId) final  int? idShopDefault;
...
@override@JsonKey(fromJson: parseUnsignedId) final  int? state;
@override@JsonKey(name: 'additional_delivery_times', fromJson: parseUnsignedId) final  int? additionalDeliveryTimes;
...
@override@JsonKey(name: 'minimal_quantity', fromJson: parseUnsignedId) final  int? minimalQuantity;
...
@override@JsonKey(name: 'unit_price_ratio') final  String? unitPriceRatio;
...
@override@JsonKey(fromJson: parseUnsignedId) final  int? customizable;
@override@JsonKey(name: 'text_fields', fromJson: parseUnsignedId) final  int? textFields;
@override@JsonKey(name: 'uploadable_files', fromJson: parseUnsignedId) final  int? uploadableFiles;
...
@override@JsonKey(name: 'id_type_redirected', fromJson: parseUnsignedId) final  int? idTypeRedirected;
...
@override@JsonKey(name: 'pack_stock_type', fromJson: parseUnsignedId) final  int? packStockType;
