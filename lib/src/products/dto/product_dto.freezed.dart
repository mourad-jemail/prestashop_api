...
@override@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) final  double? width;
@override@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) final  double? height;
@override@JsonKey(fromJson: parseIsFloat, toJson: isFloatToJson) final  double? depth;
...
@override@JsonKey(name: 'available_date', fromJson: parseIsDate, toJson: isDateToJson) final  DateTime? availableDate;
