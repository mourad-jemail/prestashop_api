...
mixin _$TaxRuleGroupDTO {
 ...
 int? get id; String? get name;@JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson) bool? get active;@JsonKey(name: 'deleted', fromJson: parseIsBool, toJson: isBoolToJson) bool? get deleted;@JsonKey(name: 'date_add', fromJson: parseIsDate, toJson: isDateToJson) DateTime? get dateAdd;@JsonKey(name: 'date_upd', fromJson: parseIsDate, toJson: isDateToJson) DateTime? get dateUpd;
/// Create a copy of TaxRuleGroupDTO
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TaxRuleGroupDTOCopyWith<TaxRuleGroupDTO> get copyWith => _$TaxRuleGroupDTOCopyWithImpl<TaxRuleGroupDTO>(this as TaxRuleGroupDTO, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaxRuleGroupDTO&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.active, active) || other.active == active)&&(identical(other.deleted, deleted) || other.deleted == deleted)&&(identical(other.dateAdd, dateAdd) || other.dateAdd == dateAdd)&&(identical(other.dateUpd, dateUpd) || other.dateUpd == dateUpd));
}
...
abstract mixin class $TaxRuleGroupDTOCopyWith<$Res>  {
  factory $TaxRuleGroupDTOCopyWith(TaxRuleGroupDTO value, $Res Function(TaxRuleGroupDTO) _then) = _$TaxRuleGroupDTOCopyWithImpl;
@useResult
$Res call({
 int? id, String? name,@JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson) bool? active,@JsonKey(name: 'deleted', fromJson: parseIsBool, toJson: isBoolToJson) bool? deleted,@JsonKey(name: 'date_add', fromJson: parseIsDate, toJson: isDateToJson) DateTime? dateAdd,@JsonKey(name: 'date_upd', fromJson: parseIsDate, toJson: isDateToJson) DateTime? dateUpd
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TaxRuleGroupDTO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _TaxRuleGroupDTO extends TaxRuleGroupDTO {
  const _TaxRuleGroupDTO({this.id, this.name, @JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson) this.active, @JsonKey(name: 'deleted', fromJson: parseIsBool, toJson: isBoolToJson) this.deleted, @JsonKey(name: 'date_add', fromJson: parseIsDate, toJson: isDateToJson) this.dateAdd, @JsonKey(name: 'date_upd', fromJson: parseIsDate, toJson: isDateToJson) this.dateUpd}): super._();
  factory _TaxRuleGroupDTO.fromJson(Map<String, dynamic> json) => _$TaxRuleGroupDTOFromJson(json);

@override final  int? id;
@override final  String? name;
@override@JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson) final  bool? active;
@override@JsonKey(name: 'deleted', fromJson: parseIsBool, toJson: isBoolToJson) final  bool? deleted;
...
@pragma('vm:prefer-inline')
_$TaxRuleGroupDTOCopyWith<_TaxRuleGroupDTO> get copyWith => __$TaxRuleGroupDTOCopyWithImpl<_TaxRuleGroupDTO>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaxRuleGroupDTO&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.active, active) || other.active == active)&&(identical(other.deleted, deleted) || other.deleted == deleted)&&(identical(other.dateAdd, dateAdd) || other.dateAdd == dateAdd)&&(identical(other.dateUpd, dateUpd) || other.dateUpd == dateUpd));
}
...
/// @nodoc
abstract mixin class _$TaxRuleGroupDTOCopyWith<$Res> implements $TaxRuleGroupDTOCopyWith<$Res> {
  factory _$TaxRuleGroupDTOCopyWith(_TaxRuleGroupDTO value, $Res Function(_TaxRuleGroupDTO) _then) = __$TaxRuleGroupDTOCopyWithImpl;
@override @useResult
$Res call({
 int? id, String? name,@JsonKey(name: 'active', fromJson: parseIsBool, toJson: isBoolToJson) bool? active,@JsonKey(name: 'deleted', fromJson: parseIsBool, toJson: isBoolToJson) bool? deleted,@JsonKey(name: 'date_add', fromJson: parseIsDate, toJson: isDateToJson) DateTime? dateAdd,@JsonKey(name: 'date_upd', fromJson: parseIsDate, toJson: isDateToJson) DateTime? dateUpd
});
