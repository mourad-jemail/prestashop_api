...
mixin _$TaxRuleGroup {
  ...
  $TaxRuleGroupCopyWith<TaxRuleGroup> get copyWith =>
      _$TaxRuleGroupCopyWithImpl<TaxRuleGroup>(
          this as TaxRuleGroup, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is TaxRuleGroup &&
...
abstract mixin class $TaxRuleGroupCopyWith<$Res> {
  factory $TaxRuleGroupCopyWith(TaxRuleGroup value,
      $Res Function(TaxRuleGroup) _then) = _$TaxRuleGroupCopyWithImpl;
...
extension TaxRuleGroupPatterns on TaxRuleGroup {
  ...
  TResult Function( _TaxRuleGroup value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _TaxRuleGroup extends TaxRuleGroup {
  const _TaxRuleGroup(
      {this.id, this.name, this.active, this.deleted, this.dateAdd, this.dateUpd})
      : super._();

  factory _TaxRuleGroup.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TaxRuleGroupCopyWith<_TaxRuleGroup> get copyWith =>
      __$TaxRuleGroupCopyWithImpl<_TaxRuleGroup>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _TaxRuleGroup &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.active, active) || other.active == active) &&
            (identical(other.deleted, deleted) || other.deleted == deleted) &&
...
/// @nodoc
abstract mixin class _$TaxRuleGroupCopyWith<$Res>
    implements $TaxRuleGroupCopyWith<$Res> {
  factory _$TaxRuleGroupCopyWith(_TaxRuleGroup value,
      $Res Function(_TaxRuleGroup) _then) = __$TaxRuleGroupCopyWithImpl;
